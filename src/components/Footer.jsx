...
const Footer = ({ isDarkMode }) => {
  return (
    <div>
      <footer
        id="footer"
        className={`footer ${isDarkMode ? "dark-footer" : "light-footer"}`}
      >
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center gap-4 rounded-lg bg-indigo-600 p-6 shadow-lg sm:flex-row sm:justify-between">
            <strong className="text-xl text-white sm:text-stroke-linecapxl">
              Start shopping!
            </strong>
          ...
          <div className="mt-16">
            ...
            <div className="mt-4 sm:flex sm:items-center sm:justify-between">
              <Link
                to="/"
                className="text-2xl font-bold tracking-wider cursor-pointer max:sm:flex text-center -mt-8"
              >
